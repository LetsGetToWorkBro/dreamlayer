...
# The panel's JS parse check moved to test_served_js_parses.py, which covers
# the Live Lens (200k characters, the phone's whole surface) and the simulator
# too. Same risk, and it was never specific to the file I happened to edit.
