...
class BrainHost:
    ...
    if TYPE_CHECKING:
        ...
        # Same reason as push_event above: `waypath_stash`/`waypath_locate` read
        # the current position to pin a coordinate and compute a live bearing,
        # and `here` lives on the composed Brain rather than on any one mixin.
