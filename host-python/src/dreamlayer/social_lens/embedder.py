"""social_lens/embedder.py — 512-d face embedding extraction.

Reuses the FaceEmbedder from truth_lens for consistent embeddings
across both modules. SocialLens and TruthLens share the same
MobileFaceNet INT8 NPU model and embedding space, so a contact
enrolled via SocialLens is immediately compatible with TruthLens.
"""
...
# Re-export from truth_lens to keep a single embedding implementation
