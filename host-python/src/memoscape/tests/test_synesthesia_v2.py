...
def test_render_gesture_is_128px():
    ...
    from memoscape.app.dream.sprite_bridge import GESTURE_SIZE, render_gesture
...
def test_render_gesture_4bpp_budget():
    ...
    pytest.importorskip("PIL")
    from memoscape.app.dream.sprite_bridge import render_gesture
...
def test_sprite_bridge_flush_sends_anchor():
    from memoscape.app.dream import sprite_bridge as sb
